...
#define A  39 // Replace the ? with the GPIO pin you selected to connect encoder A
#define B  36 // Replace the ? with the GPIO pin you selected to connect encoder B
